...

			{
				...
				btnregistrar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if (textSerial.getText().isEmpty() || textDescripcion.getText().isEmpty() || textMarca.getText().isEmpty()
								|| textModelo.getText().isEmpty() || (rdbMotherBoard.isSelected() && textSocket.getText().isEmpty())
								|| (rdbDiscoDuro.isSelected() && (cmboxConexiones.getSelectedIndex() == 0 || txtGb.getText().isEmpty()))
								|| (rdbMicro.isSelected() && (textSocket.getText().isEmpty() || txtGhz.getText().isEmpty()))
								|| (rdbMemoriaRam.isSelected() && (cmboxRam.getSelectedIndex() == 0 || txtGb.getText().isEmpty()))) {
							JOptionPane.showMessageDialog(null, "Por favor, llene todos los campos.", "Registro de Componente", JOptionPane.WARNING_MESSAGE);
						} else {
